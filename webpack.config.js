...
try {
    ...
    dhisConfig = {
        ...
        authorization: 'Basic YWRtaW46RGlzdHJpY3QxIQ==', // admin:District1!
    };
}
...
const webpackConfig = {
    context: __dirname,
    entry: './src/pcntd-app.js',
    devtool: 'source-map',
    output: {
        path: __dirname + '/build',
        filename: 'pcntd-app.js',
    ...
    devServer: {
        ...
        proxy: [
            ...
            { path: '/dhis-web-dashboard/**', target: dhisConfig.baseUrl, bypass: log },
        ],
    },
};
