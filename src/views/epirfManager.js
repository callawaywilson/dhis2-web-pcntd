...
class EpirfManager extends React.Component {
  ...
  loadUploads() {
    return new Promise(function(resolve, reject) {
      ...
      appDataStore.getUploadsForType('epirf').then(resolve);
    });
  }
  ...
  renderUpload() {
    return (
      <div className="content-area">
        ...
        <ParserUploader parserType='epirf'
          title="Upload EPIRF Workbook"
  ...
  renderDownload() {
    if (this.state.loadingDownload) {
      ...
      return (
        <div>
          <div>
          <SelectField floatingLabelText="EPIRF Data Year"
  ...
  render() {
    ...
    return (
      <div className="content-area">
        <div style={styles.header}>EPIRF Management</div>
        <Card style={styles.card}>
            <CardText>
